...
SELECT *,length(PAIS) FROM CLIENTES_NEPTUNO;
...
UPDATE PRODUCTOS SET ORIGEN = 'España' WHERE ORIGEN LIKE '%ESPANA%';
SELECT * FROM PRODUCTOS;

ALTER TABLE PRODUCTOS_NEPTUNO MODIFY SUSPENDIDO VARCHAR(2);
UPDATE PRODUCTOS_NEPTUNO SET SUSPENDIDO = 'NO' WHERE SUSPENDIDO LIKE '%0%';
UPDATE PRODUCTOS_NEPTUNO SET SUSPENDIDO = 'SI' WHERE SUSPENDIDO LIKE '%1%';
...
CREATE TABLE  PRODUCTOS_SUSPENDIDOS SELECT * FROM PRODUCTOS_NEPTUNO WHERE SUSPENDIDO LIKE '%SI%';
