...
SELECT *,TIMESTAMPDIFF(DAY,FECHAPEDIDO,CURDATE())DIASTRANSCURRIDOS,DAYNAME(FECHAPEDIDO)DIA,DAYOFYEAR(FECHAPEDIDO)DIADELANIO,MONTH(FECHAPEDIDO)MES,adddate(FECHAPEDIDO,INTERVAL 30 DAY)PRIMERVENCIMIENTO FROM PEDIDOS_NEPTUNO;
